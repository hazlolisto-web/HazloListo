...
const TICKER_ITEMS = [
  'ENTREGA EN 24H', 'DISEÑO PROFESIONAL', 'DESDE $79.000 CLP',
...
export default function Landing() {
  ...
  return (
    <>
      ...
      {/* WHATSAPP FLOTANTE */}
      <a className="wa-float" href={WA} target="_blank" rel="noreferrer" aria-label="Escribir por WhatsApp">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="28" height="28">
          ...
          <path d="M12 0C5.373 0 0 5.373 0 12c0 2.136.564 4.14 1.544 5.874L.057 23.428a.75.75 0 0 0 .916.916l5.554-1.487A11.942 11.942 0 0 0 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 22c-1.907 0-3.7-.503-5.254-1.383l-.374-.217-3.892 1.043 1.043-3.892-.217-.374A9.953 9.953 0 0 1 2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10z"/>
        </svg>
      </a>
